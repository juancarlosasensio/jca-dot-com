...
module.exports = async function () {
  ...
  // jcadotcomdata.wordpress.com

  const url = `https://public-api.wordpress.com/rest/v1.1/sites/jcadotcomdata.wordpress.com/posts/`;

  const asset = new AssetCache('drafts');
